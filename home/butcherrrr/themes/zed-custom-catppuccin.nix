{
  # Custom Catppuccin Mocha Theme for Zed Editor
  themes = [
    {
      ...
      style = {
        ...
        "status_bar.background" = "#1e1e2ef2";
        "title_bar.background" = "#1e1e2ef2";
        "title_bar.inactive_background" = "#171725";
        "toolbar.background" = "#1e1e2ef2";

        "tab_bar.background" = "#1e1e2ef2";
        "tab.inactive_background" = "#1e1e2ef2";
        "tab.active_background" = "#585b704d";

        "search.match_background" = "#94e2d533";

        "panel.background" = "#1e1e2e00";
        ...
        "scrollbar.track.background" = "#1e1e2ef2";
        ...
        "editor.background" = "#1e1e2e00";
        "editor.gutter.background" = "#1e1e2e00";
        ...
        "terminal.background" = "#1e1e2ef2";
        "terminal.ansi.background" = "#1e1e2ef2";
